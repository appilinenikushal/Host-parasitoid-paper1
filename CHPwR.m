...
for i=2:t
    ...
    h1 = a(1,i-1)*(exp(l*(1 - a(1,i-1))))*exp(-a(2,i-1));
    p1 =  g*a(1,i-1)*(exp(l*(1 - a(1,i-1))))*(1 - exp(-a(2,i-1)));
    h2 =  b(1,i-1)*(exp(l*(1 - b(1,i-1))))*exp(-b(2,i-1));
    p2 = g*b(1,i-1)*(exp(l*(1 - b(1,i-1))))*(1 - exp(-b(2,i-1)));
